...
public class HrightsFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_hrights));
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String SECTION = null;
        String QUERY = getString(R.string.query_hrights);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.hrigts_to_connection);
                }
            }
        });
    }

...
public class WellbeingFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_wellbeing));
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String SECTION = null;
        String QUERY = getString(R.string.query_wellbeing);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.wellbeing_to_connection);
                }
            }
        });
    }

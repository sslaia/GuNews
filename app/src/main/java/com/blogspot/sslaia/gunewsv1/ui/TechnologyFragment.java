...
public class TechnologyFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_technology));
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String SECTION = null;
        String QUERY = getString(R.string.query_technology);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.technology_to_connection);
                }
            }
        });

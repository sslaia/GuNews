...
public class ScienceFragment extends Fragment
    ...
    // apiKey (api key)
    String requestUrl = "https://content.guardianapis.com/search?show-fields=headline%2Cbyline%2CshortUrl%2Cthumbnail&section=science&page-size=15&api-key=";
    ...
    public void onItemClick(int position) {
        ...
        if (apiUrl != null) {
            ...
            ScienceFragmentDirections.ActionNavScienceToNewsPageFragment action =
                    ScienceFragmentDirections.actionNavScienceToNewsPageFragment();

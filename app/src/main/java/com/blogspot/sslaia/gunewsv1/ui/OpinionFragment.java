...
public class OpinionFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_opinion));
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String QUERY = null;
        String SECTION = getString(R.string.section_opinion);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.opinion_to_connection);
                }
            }
        });
    }
